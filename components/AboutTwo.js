            ...
            <div className="col-xl-6">
              <div className="about-two__content">
                ...
                <p className="about-two__text">
                  Everyone has ideas they can share. Whether it's about how to
                  successfully garden in an urban environment or tips on how to
                  build a business from scratch.
                </p>
                <p className="about-two__text">
                  The world is filled with opportunities for you to share your
                  knowledge, regardless of where that knowledge comes from and
                  whether or not you've ever taught a course in the past.
                </p>
